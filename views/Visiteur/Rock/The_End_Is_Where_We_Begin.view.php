<div class="container-fluid">
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-12 g-12">
        ...
        <div class="col-sm-3 "style = "margin:0%; padding:0%;">
            <div class="card">
                <img class="background-image"  style = "background-image:url(public/Assets/images/Vignes.jpg); min-height:1750px;background-attachment:fixed;
        ...
        <div class="col-sm-6" style = " text-align:center; background-color:#FDF5E6 ;">
            <br/> <br/><br/> <br/><br/> <br/>
            <h1 class="card-title" style="color:black; text-align:center;"> <strong>The End Is Where We Begin</strong></h1>
            <div class="player">
                
                <div class="wrapper">
                    <div class="details">
                        <img class="track-art" src="public\Assets\images\Album\Rock\TFK\TheEndIsWhereWeBegin.jpg" alt="Card image cap">
                        <div class="track-name">War of Change</div>
                        <div class="track-artist">Thousand foot Krutch</div>
                    </div>
            ...
            <div class="row" style="text-align:left;">
                    ...
                    <a href="<?= URL; ?>achatTEIWWB" class="btn btn-primary btn-lg">Acheter pour 22€</a>
        ...
        <div class="col-sm-3"  style = "margin:0%; padding:0%;">
            <div class="card">  
                <img class="background-image"  style = "background-image:url(public/Assets/images/ArmoireV.jpg); min-height:1750px;background-attachment:fixed;
                background-position:center; background-repeat:no-repeat; background-size:cover; z-index:5;">
            </div>
        </div>
