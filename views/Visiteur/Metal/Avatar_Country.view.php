<div class="container-fluid">
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-12 g-12">
        ...
        <div class="col-sm-3 "style = "margin:0%; padding:0%;">
            <div class="card">
                <img class="background-image"  style = "background-image:url(public/Assets/images/Vignes.jpg); min-height:1610px;background-attachment:fixed;
        ...
        <div class="col-sm-6" style = " text-align:center; background-color:#FDF5E6 ;">
            ...
            <div class="player">
                ...
                <div class="row" style="text-align:left;">
                    ...
                    <a href="<?= URL; ?>achatAC" class="btn btn-primary btn-lg">Acheter pour 25€</a>
        ...
        <div class="col-sm-3"  style = "margin:0%; padding:0%;">
            <div class="card">  
                <img class="background-image"  style = "background-image:url(public/Assets/images/ArmoireV.jpg); min-height:1610px;background-attachment:fixed;
                background-position:center; background-repeat:no-repeat; background-size:cover; z-index:5;">
            </div>
        </div>
